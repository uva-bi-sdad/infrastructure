...
grant_db_permissions <- function(grant_database, grant_username, schema = "public", db_user = Sys.getenv("db_userid"), db_pass = Sys.getenv("db_pwd"), db_host = "postgis1", db_port = "5432") {
